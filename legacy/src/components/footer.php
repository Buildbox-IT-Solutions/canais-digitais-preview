...
/**
 * Componente: Footer
 * Figma: https://www.figma.com/design/WGDRkmJLtuow7gRmPRAwJk/Canais-Digitais-2.0?node-id=335-9364
 * Variantes: device (Desktop|Mobile) = 2
 *
 * Footer do Food Connection (by Informa Markets). bg primary-600, texto
 * branco. Contém: Brand/Informa logo + grid de 11 editorias + descrição
 * oficial + legal links + copyright. Social list vertical à direita
 * (desktop) ou horizontal no topo (mobile). NÃO TEM formulário de
 * newsletter (divergente do padrão editorial genérico).
 *
 * Tokens: bg-primary-600 · text-white · text-label-lg · text-body-sm ·
 *         border-neutral-100 (usado como divider semi-light no dark bg) ·
...
<div class="space-y-10">
  ...
  <footer class="w-full bg-primary-600 text-white">
    <div class="max-w-screen-xl mx-auto flex gap-[72px] items-start px-6">
      ...
      <div class="flex-1 flex flex-col items-start">
        ...
        <!-- Grid de 11 editorias (4 cols × 3 rows) -->
        <div class="grid grid-cols-4 gap-x-14 gap-y-4 py-4 w-full">
          <a href="#" class="font-body font-semibold text-label-lg text-white hover:text-primary-100 transition-colors">Eventos</a>
          <a href="#" class="font-body font-semibold text-label-lg text-white hover:text-primary-100 transition-colors">Ingredientes</a>
          <a href="#" class="font-body font-semibold text-label-lg text-white hover:text-primary-100 transition-colors">Indústria A&amp;B</a>
          <a href="#" class="font-body font-semibold text-label-lg text-white hover:text-primary-100 transition-colors">Proteína Animal</a>
          <a href="#" class="font-body font-semibold text-label-lg text-white hover:text-primary-100 transition-colors">Food Service</a>
          <a href="#" class="font-body font-semibold text-label-lg text-white hover:text-primary-100 transition-colors">Sorvetes</a>
          <a href="#" class="font-body font-semibold text-label-lg text-white hover:text-primary-100 transition-colors">Tecnologia</a>
          <a href="#" class="font-body font-semibold text-label-lg text-white hover:text-primary-100 transition-colors">Embalagens</a>
          <a href="#" class="font-body font-semibold text-label-lg text-white hover:text-primary-100 transition-colors">ESG</a>
          <a href="#" class="font-body font-semibold text-label-lg text-white hover:text-primary-100 transition-colors">Especialistas</a>
          <a href="#" class="font-body font-semibold text-label-lg text-white hover:text-primary-100 transition-colors">E-books</a>
        </div>
        ...
        <!-- Linha bottom: legal links + copyright -->
  ...
  <!-- ================================================================
       MOBILE
       ================================================================ -->
  <footer class="w-[375px] bg-primary-600 text-white">
    <!-- Brand -->
    ...
    <!-- Editorias (2 cols × 6 rows) -->
    <div class="flex gap-6 items-start p-4 w-full">
    ...
    <!-- Divider + descrição + Divider -->
    <div class="flex flex-col gap-4 items-center justify-center px-4 py-2 w-full">
      <div class="h-px w-full bg-neutral-100/50"></div>
      <p class="text-body-sm font-body text-white leading-4">
        Canal de conteúdo oficial das feiras FiSA, Fispal Tecnologia, Tecnocarne e Fispal Food Service. Aqui você encontra conteúdo relevante e entrevistas com profissionais que compartilham informações, tendências e ideias para revolucionar a cadeia de alimentos e bebidas.
      </p>
      <div class="h-px w-full bg-neutral-100/50"></div>
    </div>

    <!-- Legal links (2 cols × 2 rows) -->
    <div class="flex gap-6 items-start justify-center px-4 py-2 w-full">
      <div class="flex-1 flex flex-col gap-4 items-start">
        <a href="#" class="font-body font-semibold text-label-lg text-white hover:text-primary-100 transition-colors">Acessibilidade</a>
        <a href="#" class="font-body font-semibold text-label-lg text-white hover:text-primary-100 transition-colors">Termos e condições do visitante</a>
      </div>
    ...
    <!-- Copyright -->
    <div class="flex items-center justify-center px-4 py-8 w-full">
      <p class="flex-1 font-body text-body-sm text-white">© 2026 Informa PLC</p>
    </div>
  </footer>
